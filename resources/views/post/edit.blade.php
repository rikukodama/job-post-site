        ...
        <div class="col-sm-12 col-md-12">
          <form action="{{route('post.update',['post'=>$post])}}" id="postForm" method="POST">
            ...
            <div class="form-group">
              <label for="">職種</label>
              <input type="text" placeholder="職種" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="{{ $post->job_title }}" required autofocus >
              @error('job_title')
...
{{-- 
            ...
            {{-- <div class="form-group">
              <label for="">勤務地</label>
              <input type="text" placeholder="勤務地" class="form-control @error('job_location') is-invalid @enderror" name="job_location" value="{{ $post->job_location }}" required >
              @error('job_location')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            {{-- <div class="form-group">
              ...
              <input type="text" placeholder="スキル1、スキル2など" class="form-control @error('skills') is-invalid @enderror" name="skills" value="{{ $post->skills }}" required >
            </div> --}}
            ...
            <button type="button" id="postBtn" class="btn primary-btn">求人情報を更新する</button>
          </form>
        </div>
      </div>
    </div>
