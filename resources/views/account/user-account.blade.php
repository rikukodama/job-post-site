                ...
                <div class="row m-l-0 m-r-0">
                    <div class="col-sm-4 bg-c-lite-green user-profile">
                        <div class="card-block text-center text-white">
                            ...
                            @endrole
                            @role('admin')
                            <p>管理者 <i class="fas fa-pen-square"></i></p> 
                            @endrole
                        </div> 
                    </div>
                    <div class="col-sm-8">
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="m-b-10 f-w-600">電子メール</p>
                                <h6 class="text-muted f-w-400">{{auth()->user()->email}}</h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="m-b-10 f-w-600">電話</p>
                                    <h6 class="text-muted f-w-400">設定されていません</h6>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <a href="{{route('account.changePassword')}}" class="btn primary-outline-btn">パスワードを変更する</a>
                                </div>
                                <div class="col-sm-6">
                                  <p class="m-b-10 f-w-600">ログアウト</p>
                                    <a href="{{route('logout')}}" class="btn btn-outline-dark">ログアウト</a>
                                </div>
                            </div>
