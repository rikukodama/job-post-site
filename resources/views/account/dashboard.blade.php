                ...
                <div class="col-xl-4 col-sm-6 py-2">
                    <div class="card dashboard-card text-white h-100 shadow">
                        <div class="card-body primary-bg">
                            ...
                            <h6 class="text-uppercase">ユーザー</h6>
                ...
                <div class="col-xl-4 col-sm-6 py-2">
                    <div class="card dashboard-card text-white  h-100 shadow">
                        <div class="card-body bg-secondary">
                            ...
                            <h6 class="text-uppercase">投稿の数 </h6>
                ...
                <div class="col-xl-4 col-sm-6 py-2">
                    <div class="card dashboard-card text-white h-100 shadow">
                        <div class="card-body bg-warning">
                            ...
                            <h6 class="text-uppercase">会社のカテゴリー</h6>
            ...
            {{-- <section class="dashboard-authors my-5">
                <div class="row my-4">
                    <div class="col-lg-12 col-md-8 col-sm-12">
                        <h4 class="card-title text-secondary">著者の管理 (ジョブリスト作成者) </h4>
                        ...
                        <button class="btn primary-outline-btn disabled">登録されている著者の合計数 ({{ $recentAuthors->total() }})
                        </button>
                ...
                <div class="row my-4">
                    <div class="col-sm-12 col-md-12">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#categories-tab" role="tab"
                                    data-toggle="tab">会社のカテゴリー</a>
                            </li>
                            {{-- <li class="nav-item">
                                <a class="nav-link" href="#roles-tab" role="tab" data-toggle="tab">役割</a>
                            </li> --}}
                            {{-- <li class="nav-item">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="categories-tab">
                                <div class="mb-3">
                                    <form action="{{ route('category.store') }}" method="POST">
                                        @csrf
                                        <label for="">新しいカテゴリを追加する</label>
                                        <div class="d-flex">
                                            <input type="text" class="form-control" placeholder="会社カテゴリ名"
                                                name="category_name">
                                            ...
                                            @foreach ($companyCategories as $category)
                                                <tr>
                                                    ...
                                                    <td><a class="btn secondary-btn"
                                                            href="{{ route('category.edit', ['category' => $category]) }}">編集</a>
                                                        <form onsubmit="handleFormSubmit(event)" method='DELETE' class="d-inline" action="/account/category/{{$category->id}}">
                                                            <button class="btn danger-btn">消去</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn secondary-btn" href="">Edit</a>
                                                        <form action="" class="d-inline"><button type="submit"
                                                                class="btn danger-btn">消去</button></form>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($role->permissions->count() == 0)
                                                            <span class="badge badge-primary">基本認証権限</span>
                                                        @else
