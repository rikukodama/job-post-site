              ...
              <a href="{{route('jobApplication.index')}}">
                <div class="card dashboard-card text-white h-100 shadow">
                    <div class="card-body bg-danger">
                        ...
                        <h6 class="text-uppercase">総申請数</h6>
      ...
      <section class="author-company-info">
          <div class="row">
              <div class="col-sm-12 col-md-12">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="card-title">会社登録</h4>
                          <p class="mb-3 alert alert-info">就職活動をしている会社を登録してください。</p>
                          
                          <div class="mb-3 d-flex">
                            @if(!$company)
                            <a href="{{route('company.create')}}" class="btn primary-btn mr-2">会社登録</a>
      ...
      <section class="author-posts">
        <div class="row my-4">
          <div class="col-lg-12 col-md-8 col-sm-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title mb-3">投稿管理</h4>
                <a href="{{route('post.create')}}" class="btn primary-btn">新規投稿</a>
              </div>
            </div>
                        ...
                        @if($company)
                            ...
                            <tr>
                                ...
                                <form action="{{route('post.destroy',['post'=>$post->id])}}" class="d-inline-block" id="delPostForm" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" id="delPostBtn" class="btn danger-btn">消去</button>
                                </form>
                                </td> 
                            </tr>
                            @endforeach
