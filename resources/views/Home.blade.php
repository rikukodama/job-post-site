          ...
          <div class="col-sm-12 col-md-6">
            <div class="px-4">
              ...
              <div class="home-search-bar">
                  <input type="text" name="q" placeholder="会社で検索" class="home-search-input form-control">
    ...
    <div class="container-fluid px-0">
      <div class="row ">
        <div class="col-sm-12 col-md-7 ml-auto">
          <div class="card">
            <div class="card-header">
              <p class="card-title font-weight-bold"><i class="fas fa-briefcase"></i> 最近の投稿</p>
            </div>
            <div class="card-body">
              <div class="top-jobs" >
                <div class="row">
              ...
              <a class="btn secondary-btn" href="{{route('job.index')}}">もっと見る...</a>
            </div>
          </div>
        ...
        <div class="col-sm-12 col-md-3 mr-auto">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <p class="font-weight-bold"><i class="fas fa-building"></i> 最近投稿した学生</p>
            </div>
            <div class="card-body">
            ...
            <div class="card mb-4 job-by-category">
              <div class="card-header">
                <p class="font-weight-bold"><i class="fab fa-typo3"></i> カテゴリ分類</p>
              </div>
              <div class="card-body">
                <div class="jobs-category mb-3 mt-0">
                  ...
                  @endforeach
                  <a class="p-1 text-info" href="{{route('job.index')}}">もっと..</a>
                </div>
              </div>
            </div> 
          </div>
