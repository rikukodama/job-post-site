              ...
              <div class="col-md-12 input-group">
                ...
                <span class="input-group-append">
                  <button class="btn btn-success pt-1" @click="searchByTitle">
                    <span class="icon-search"></span> 投稿検索
                  </button>
                </span>
              </div>
            </div>
        ...
        <div class="col-sm-12 col-md-6 offset-md-3 small text-center my-2">
          <div class="row">
            <div class="col-sm-6 col-md-3">
              <router-link to="/">すべての投稿</router-link>
            </div>
            <div class="col-sm-6 col-md-3">
            ...
            <div class="col-sm-6 col-md-3">
              <router-link to="/jobs-by-category">業種別</router-link>
            </div>
            <div class="col-sm-6 col-md-3">
              <router-link to="/jobs-by-title">職種別</router-link>
            </div>
          </div>
        </div>
      </div>
