  ...
  <div class="job-component">
    <div class="row">
      <div class="col-sm-12 col-md-5 col-xl-4">
        <Sidebar @get-by-category="getByCategory" @get-by-job-level="getByJobLevel"
          @get-by-employmentType="getByEmploymentType" @get-by-education="getByEducation" />
      </div>
      <div class="col-sm-12 col-md-7 col-xl-8">
        ...
        <div class="card" v-else>
          <SearchResult :posts="posts.data" :from="posts.from" :to="posts.to" :total="posts.total" />
          ...
          <div class="my-4 text-center small">
            ...
            <div class="d-flex justify-content-center">
              <pagination class="custom-pagination" :data="posts" @pagination-change-page="getJobs"></pagination>
            </div>
          </div>
        </div>
      </div>
